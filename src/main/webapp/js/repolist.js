...
function deleteBill(obj){
	...
	$.ajax({
		type:"GET",
		url:path+"/jsp/repo.do",
		data:{method:"delrepo",repoid:obj.attr("billid")},
		dataType:"json",
...
$(function(){
	...
	$(".modifyBill").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/jsp/repo.do?method=modify&repoid="+ obj.attr("billid")+
		"&providerCode="+obj.attr("secretProviderCode");
	});
	$('#no').click(function () {
		cancleBtn();
	});
	...
	$(".deleteBill").on("click",function(){
		billObj = $(this);
		changeDLGContent("你确定要删除库存【"+billObj.attr("billcc")+"】吗？");
		openYesOrNoDLG();
	});
