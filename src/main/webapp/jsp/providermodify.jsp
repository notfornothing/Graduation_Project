...
<%@include file="/jsp/common/head.jsp"%>
  ...
  <div class="right">
      <div class="location">
          ...
          <span>商品信息管理页面 >> 供应商修改页</span>
      </div>
      <div class="providerAdd">
          <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/jsp/provider.do?method=modifysave">
...
<%--                添加一个 隐藏域 --%>
                  <input type="text" name="ppp" hidden id="ppp" value="${proid}">
<%--                  --%>
