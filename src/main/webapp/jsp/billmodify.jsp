    ...
    <div class="providerAdd">
        <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/jsp/bill.do">
            ...
            <div>
                ...
                <input type="text" name="productName" id="productName" value="${bill.productName }" readonly="readonly">
                <font color="red"></font>
            </div>
            <div>
                <label for="productUnit">商品单位：</label>
                <input type="text" name="productUnit" id="productUnit" value="${bill.productUnit }" readonly="readonly">
                <font color="red"></font>
            </div>
            <div>
            ...
            <div>
                <label>供应商：</label>
                <input type="hidden" name="providerId" value="${bill.providerId}">
                <input type="hidden" value="${bill.providerId }" readonly="readonly" id="pid"/>
                <font color="red"></font>
                <input id="lucy" value="">
            </div>
            <div>
